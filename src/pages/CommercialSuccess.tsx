...
import { Trophy, TrendingUp, DollarSign, Target, Users, BarChart, Globe, BarChart as ChartBar, ArrowUpRight, Award, Briefcase, CheckCircle } from 'lucide-react';
...
export default function CommercialSuccess() {
  ...
  const achievements = [
    {
      ...
      description: "Led digital transformation initiatives resulting in 150% revenue growth over 3 years",
      metrics: ["$100M+ in new revenue", "60% increase in digital sales", "35% market share growth"]
    },
    {
      icon: <TrendingUp className="w-12 h-12 text-blue-600" />,
      title: "Cost Optimization",
      description: "Implemented innovative solutions reducing operational costs by 40%",
      metrics: ["$20M annual savings", "30% process efficiency improvement", "50% reduction in manual tasks"]
    },
    {
      icon: <DollarSign className="w-12 h-12 text-blue-600" />,
      title: "Client Portfolio",
      description: "Managed $50M+ worth of strategic partnerships with Fortune 500 companies",
      metrics: ["95% client retention rate", "40+ active partnerships", "20% YoY portfolio growth"]
    }
  ];
  ...
  const strategies = [
    {
      ...
      description: "Strategic entry into 25+ new markets with localized approaches"
    },
    {
  ...
  return (
    <div className="py-20 bg-white">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 py-20 mb-20">
        <div className="container mx-auto px-6 text-white">
          <h1 className="text-4xl font-bold mb-6">Commercial Success</h1>
          <p className="text-xl opacity-90 max-w-2xl">
            Driving sustainable growth through strategic innovation, operational excellence, 
            and transformative leadership in global markets.
          </p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {achievements.map((achievement, index) => (
            <div key={index} className="bg-gray-50 p-8 rounded-xl shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-4 text-center">{achievement.title}</h3>
      ...
      <div className="bg-gray-50 py-20 mb-20">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold mb-12 text-center">Strategic Approach</h2>
          <div className="grid md:grid-cols-4 gap-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {successStories.map((story, index) => (
            <div key={index} className="bg-white rounded-xl overflow-hidden shadow-lg">
              <img src={story.image} alt={story.company} className="w-full h-48 object-cover" />
              <div className="p-6">
      ...
      <div className="bg-gray-50 py-20">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold mb-12 text-center">Key Milestones</h2>
