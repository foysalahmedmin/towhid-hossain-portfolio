...
import { ExternalLink, Calendar, User, Tag, ArrowRight, Globe, BookOpen, TrendingUp, Users, Target, Search } from 'lucide-react';

export default function News() {
  const featuredNews = {
    image: "https://images.unsplash.com/photo-1661956602116-aa6865609028?auto=format&fit=crop&q=80&w=1400",
    title: "Revolutionizing Business Leadership in the Digital Age",
    source: "Global Business Review",
    date: "March 20, 2024",
    author: "Sarah Chen",
    category: "Leadership",
    excerpt: "John Anderson shares groundbreaking insights on navigating the complexities of modern business leadership and digital transformation strategies that are reshaping industries worldwide.",
    readTime: "8 min read",
  ...
  const newsItems = [
    {
      ...
      category: "Innovation",
      excerpt: "An in-depth analysis of how strategic leadership and innovative approaches are transforming traditional business models and creating new opportunities in the digital landscape.",
      readTime: "6 min read",
    ...
    },
    {
      ...
      excerpt: "Exploring the evolving landscape of global business leadership and the key strategies that will define success in the coming decades.",
      readTime: "5 min read",
    ...
    },
    {
      ...
      excerpt: "A comprehensive look at implementing sustainable practices in modern business operations while maintaining profitability and growth.",
      readTime: "7 min read",
  ...
  const pressReleases = [
    {
      ...
      excerpt: "Announcement of keynote speech on digital transformation and future of business leadership."
    },
    {
      date: "March 12, 2024",
      title: "Strategic Partnership Announcement with Tech Innovation Hub",
      excerpt: "New collaboration to accelerate digital transformation initiatives across industries."
    },
    {
      date: "March 8, 2024",
      title: "Launch of Global Mentorship Program",
      excerpt: "Initiative to support emerging business leaders in developing markets."
    }
  ];
  ...
  return (
    <div className="py-20 bg-gray-50">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 py-24 mb-12">
        <div className="container mx-auto px-6 text-white">
          <h1 className="text-4xl font-bold mb-6">Latest News & Updates</h1>
          <p className="text-xl opacity-90 max-w-2xl">
            Stay informed about the latest developments, insights, and achievements in business
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <div className="space-y-3">
                {categories.map((category, index) => (
                  <div key={index} className="flex items-center justify-between hover:bg-gray-50 p-2 rounded">
                ...
                {upcomingEvents.map((event, index) => (
                  <div key={index} className="flex items-start space-x-4 border-b border-gray-100 last:border-0 pb-4 last:pb-0">
                    ...
                    <div>
                      ...
                      <div className="text-blue-600 text-sm mt-1">{event.role}</div>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 text-white">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="mb-6 opacity-90">
              Subscribe to our newsletter for the latest insights, news, and updates
